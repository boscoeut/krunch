    ...
    return (
        <Box>
            ...
            <Stack direction={"row"} >
                ...
                <SubStat numValue={exchange.rewards?.toNumber()+exchange.rebates?.toNumber()} title="Rewards + Rebates" value={formatCurrency(exchange.rewards / AMOUNT_DECIMALS+exchange.rebates / AMOUNT_DECIMALS)} />
